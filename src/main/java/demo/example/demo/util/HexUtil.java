...
public class HexUtil {
    ...
    public static char[] getDigitsLower() {
        return DIGITS_LOWER;
    }
     ...
     * @return
     */
    public static String toJavaByteArray (String hexStr){
        ...
        for(int i = 0; i < hexStr.length(); i+=2){
            if(i > 0)
                sb.append(",");
            sb.append("(byte)0x"+chars[i]+chars[i+1]);
        }
     ...
     * @return
     */
     public static String hexToCArray (String hexStr){
        StringBuffer sb = new StringBuffer();
        sb.append("{");
        char[] chars = hexStr.toCharArray();
        for(int i = 0; i < hexStr.length(); i+=2){
            if(i > 0)
                sb.append(",");
            sb.append("0x"+chars[i]+chars[i+1]);
        }
